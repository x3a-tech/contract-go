...
func (x *NewSourceCategory) Reset() {
	*x = NewSourceCategory{}
	mi := &file_news_source_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NewSourceCategory) Descriptor() ([]byte, []int) {
	return file_news_source_proto_rawDescGZIP(), []int{6}
}
...
var file_news_source_proto_rawDesc = string([]byte{
	...
	0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x66, 0x0a, 0x0e, 0x53,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x55, 0x75, 0x69, 0x64, 0x2a, 0x4a, 0x0a, 0x0a, 0x53, 0x6f,
	...
	0x47, 0x52, 0x41, 0x4d, 0x10, 0x03, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_news_source_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
